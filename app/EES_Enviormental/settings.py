...
BASE_DIR2 = Path(__file__).resolve().parent.parent.parent.parent.parent.parent.parent
...
EMAIL_HOST_PASSWORD = 'qkcufopwjyavcpqn' #os.environ.get('EMAIL_HOST_PASSWORD')

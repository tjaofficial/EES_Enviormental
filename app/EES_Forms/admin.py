...
admin.site.register(form5_readings_model)
...
admin.site.register(form17_readings_model)
admin.site.register(form18_model)
admin.site.register(form18_readings_model)
admin.site.register(form19_model)
admin.site.register(form19_readings_model)

...
urlpatterns = [
    ...
    path("<str:facility>/Daily/formE/<int:fsID>/<str:selector>", views.formE, name="formE"),
    path("<str:facility>/Weekly/formF1/<int:fsID>/<str:selector>", views.formF1, name="formF1"),
    path("<str:facility>/Weekly/formF2/<int:fsID>/<str:selector>", views.formF2, name="formF2"),
    path("<str:facility>/Weekly/formF3/<int:fsID>/<str:selector>", views.formF3, name="formF3"),
    path("<str:facility>/Weekly/formF4/<int:fsID>/<str:selector>", views.formF4, name="formF4"),
    path("<str:facility>/Weekly/formF5/<int:fsID>/<str:selector>", views.formF5, name="formF5"),
    path("<str:facility>/Weekly/formF6/<int:fsID>/<str:selector>", views.formF6, name="formF6"),
    path("<str:facility>/Weekly/formF7/<int:fsID>/<str:selector>", views.formF7, name="formF7"),
    path("<str:facility>/Weekly/formG1/<int:fsID>/<str:selector>", views.formG1, name="formG1"),
    path("<str:facility>/Monthly/formG2/<int:fsID>/<str:selector>", views.formG2, name="formG2"),
    path("<str:facility>/Weekly/formH/<int:fsID>/<str:selector>", views.formH, name="formH"),
    path("<str:facility>/Daily/formI/<int:fsID>/<str:selector>", views.formI, name="formI"),
    path("<str:facility>/Daily/formL/<int:fsID>/<str:selector>", views.formL, name="formL"),
    path("<str:facility>/Daily/formM/<int:fsID>/<str:selector>", views.formM, name="formM"),
    path("<str:facility>/Monthly/formN/<int:fsID>/<str:selector>", views.formN, name="formN"),
    path("<str:facility>/Daily/formO/<int:fsID>/<str:selector>/<str:weekend_day>", views.formO, name="formO"),
    path("<str:facility>/Daily/formP/<int:fsID>/<str:selector>/<str:weekend_day>", views.formP, name="formP"),
    path("<str:facility>/Monthly/spill_kits/<int:fsID>/<str:selector>", views.spill_kits, name="spill_kits"),
    path("<str:facility>/Monthly/spill_kits/<int:fsID>/<str:month>/<int:skNumber>/<str:selector>", views.spill_kits_inventory_form, name="skInventory"),
    path("<str:facility>/Quarterly/quarterly_trucks/<int:fsID>/<str:selector>", views.quarterly_trucks, name="quarterly_trucks"),

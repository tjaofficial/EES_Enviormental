...
urlpatterns = [
    ...
    ##---FORMS
    path("<str:facility>/Daily/1/<int:fsID>/<str:selector>", views.formA1, name="form1"),
    path("<str:facility>/Daily/2/<int:fsID>/<str:selector>", views.formA2, name="form2"),
    path("<str:facility>/Daily/3/<int:fsID>/<str:selector>", views.formA3, name="form3"),
    path("<str:facility>/Daily/4/<int:fsID>/<str:selector>", views.formA4, name="form4"),
    path("<str:facility>/Daily/5/<int:fsID>/<str:selector>", views.formA5, name="form5"),
    path("<str:facility>/Daily/6/<int:fsID>/<str:selector>", views.formB, name="form6"),
    path("<str:facility>/Daily/7/<int:fsID>/<str:selector>", views.formC, name="form7"),
    path("<str:facility>/Weekly/8/<int:fsID>/<str:selector>", views.formD, name="form8"),
    path("<str:facility>/Daily/9/<int:fsID>/<str:selector>", views.formE, name="form9"),
    ...
    path("<str:facility>/Weekly/17/<int:fsID>/<str:selector>", views.formG1, name="form17"),
    path("<str:facility>/Monthly/18/<int:fsID>/<str:selector>", views.formG2, name="formG18"),
    path("<str:facility>/Weekly/19/<int:fsID>/<str:selector>", views.formH, name="form19"),
    path("<str:facility>/Daily/20/<int:fsID>/<str:selector>", views.formI, name="form20"),
    path("<str:facility>/Daily/21/<int:fsID>/<str:selector>", views.formL, name="form21"),
    path("<str:facility>/Daily/22/<int:fsID>/<str:selector>", views.formM, name="form22"),

...
class formA5_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'wind_speed_start': forms.NumberInput(attrs={'oninput': 'weatherStoplight()',  'onchange': 'reload()', 'class': 'input', 'type': 'number', 'style': 'width: 40px; text-align: center;'}),
            ...
            'ambient_temp_start': forms.NumberInput(attrs={'oninput': 'weatherStoplight()', 'onchange': 'reload()', 'class': 'input', 'type': 'number', 'style': 'width: 40px; text-align: center;'}),

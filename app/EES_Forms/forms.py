...
class formA5_readings_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'o2_stop' : forms.TimeInput(attrs={'id': 'o2_stop', 'oninput': 'timecheck_pt2()', 'type':'time', 'style':'width: 120px;'}),
            'o3_start' : forms.TimeInput(attrs={'id': 'o3_start', 'oninput': 'timecheck_pt3()', 'type':'time', 'style':'width: 120px;'}),
            'o3_stop' : forms.TimeInput(attrs={'id': 'o3_stop', 'oninput': 'timecheck_pt3()', 'type':'time', 'style':'width: 120px;'}),
            'o4_start' : forms.TimeInput(attrs={'id': 'o4_start', 'oninput': 'timecheck_pt4()', 'type':'time', 'style':'width: 120px;'}),
            'o4_stop' : forms.TimeInput(attrs={'id': 'o4_stop', 'oninput': 'timecheck_pt4()', 'type':'time', 'style':'width: 120px;'}),
...
class formB_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fugitive_dust_observed_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_applied_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_active_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'working_face_exceed_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'spills_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'pushed_back_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'coal_vessel_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'water_sprays_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'loader_lowered_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'working_water_sprays_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'barrier_thickness_0' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;'}),
            'surface_quality_0' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;'}),
            'surpressant_crust_0' : forms.Select(attrs={'oninput': 'info_already_entered()', 'style':'width: 50px;'}),
            ...
            'wharf_0' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            'breeze_0' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            ...
            'fugitive_dust_observed_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_applied_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_active_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'working_face_exceed_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'spills_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'pushed_back_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'coal_vessel_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'water_sprays_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'loader_lowered_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'working_water_sprays_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'barrier_thickness_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;'}),
            'surface_quality_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;'}),
            'surpressant_crust_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;'}),
            ...
            'wharf_1' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            'breeze_1' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            ...
            'fugitive_dust_observed_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_applied_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_active_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'working_face_exceed_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'spills_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'pushed_back_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'coal_vessel_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'water_sprays_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'loader_lowered_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'working_water_sprays_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'barrier_thickness_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;'}),
            'surface_quality_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;'}),
            'surpressant_crust_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;'}),
            ...
            'wharf_2' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            'breeze_2' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            ...
            'fugitive_dust_observed_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_applied_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_active_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'working_face_exceed_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'spills_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'pushed_back_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'coal_vessel_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'water_sprays_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'loader_lowered_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'working_water_sprays_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'barrier_thickness_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;'}),
            'surface_quality_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;'}),
            'surpressant_crust_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;'}),
            ...
            'wharf_3' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            'breeze_3' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;'}),
            ...
            'fugitive_dust_observed_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_applied_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'supressant_active_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'working_face_exceed_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'spills_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'pushed_back_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;'}),
            'coal_vessel_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'water_sprays_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'loader_lowered_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'working_water_sprays_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;'}),
            'barrier_thickness_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;'}),
            'surface_quality_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;'}),
            'surpressant_crust_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;'}),
...
class formD_form(ModelForm):
    class Meta:
        ...
        widgets = {
            'week_start': forms.DateInput(attrs={'type':'date', 'style':'width: 140px;'}),
            'week_end': forms.DateInput(attrs={'type':'date', 'style':'width: 140px;'}),
            'truck_id1' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'date1' : forms.DateInput(attrs={'onchange': 'if_one_then_all()', 'type':'date', 'style':'width: 140px;'}),
            'time1' : forms.TimeInput(attrs={'onchange': 'if_one_then_all()', 'type':'time', 'style':'width: 120px;'}),
            'contents1' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'freeboard1' : forms.Select(attrs={'oninput': 'freeboard_1()', 'style':'width: 80px;'}),
            'wetted1' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'comments1' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'type':'text', 'style':'width: 60px;'}),
            'truck_id2' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'date2' : forms.DateInput(attrs={'onchange': 'if_one_then_all()', 'type':'date', 'style':'width: 140px;'}),
            'time2' : forms.TimeInput(attrs={'onchange': 'if_one_then_all()', 'type':'time', 'style':'width: 120px;'}),
            'contents2' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'freeboard2' : forms.Select(attrs={'oninput': 'freeboard_2()', 'style':'width: 80px;'}),
            'wetted2' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'comments2' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'type':'text', 'style':'width: 60px;'}),
            'truck_id3' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'date3' : forms.DateInput(attrs={'onchange': 'if_one_then_all()', 'type':'date', 'style':'width: 140px;'}),
            'time3' : forms.TimeInput(attrs={'onchange': 'if_one_then_all()', 'type':'time', 'style':'width: 120px;'}),
            'contents3' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'freeboard3' : forms.Select(attrs={'oninput': 'freeboard_3()', 'style':'width: 80px;'}),
            'wetted3' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'comments3' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'type':'text', 'style':'width: 60px;'}),
            'truck_id4' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'date4' : forms.DateInput(attrs={'onchange': 'if_one_then_all()', 'type':'date', 'style':'width: 140px;'}),
            'time4' : forms.TimeInput(attrs={'onchange': 'if_one_then_all()', 'type':'time', 'style':'width: 120px;'}),
            'contents4' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'freeboard4' : forms.Select(attrs={'oninput': 'freeboard_4()', 'style':'width: 80px;'}),
            'wetted4' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'comments4' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'type':'text', 'style':'width: 60px;'}),
            'truck_id5' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'date5' : forms.DateInput(attrs={'onchange': 'if_one_then_all()', 'type':'date', 'style':'width: 140px;'}),
            'time5' : forms.TimeInput(attrs={'onchange': 'if_one_then_all()', 'type':'time', 'style':'width: 120px;'}),
            'contents5' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'freeboard5' : forms.Select(attrs={'oninput': 'freeboard_5()', 'style':'width: 80px;'}),
            'wetted5' : forms.Select(attrs={'onchange': 'if_one_then_all()', 'style':'width: 80px;'}),
            'comments5' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'type':'text', 'style':'width: 60px;'}),
            'observer1' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'style':'width: 150px;'}),
            'observer2' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'style':'width: 150px;'}),
            'observer3' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'style':'width: 150px;'}),
            'observer4' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'style':'width: 150px;'}),
            'observer5' : forms.TextInput(attrs={'onchange': 'if_one_then_all()', 'style':'width: 150px;'}),
        }

...
class SubFormC1(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'sto_start_time': forms.TimeInput(attrs={'oninput': 'formC_timeCheck_storage()', 'class': 'input', 'type': 'time'}),
            'sto_stop_time': forms.TimeInput(attrs={'oninput': 'formC_timeCheck_storage()', 'class': 'input', 'type': 'time'}),
            'salt_start_time': forms.TimeInput(attrs={'oninput': 'formC_timeCheck_salt()', 'class': 'input', 'type': 'time'}),
            'salt_stop_time': forms.TimeInput(attrs={'oninput': 'formC_timeCheck_salt()', 'class': 'input', 'type': 'time'}),
            ...
            'average_storage': forms.NumberInput(attrs={'oninput': 'storage_average()', 'id': 'average_storage', 'class': 'input', 'type': 'number', 'style': 'width: 50px; text-align: center;'}),
            'average_salt': forms.NumberInput(attrs={'oninput': 'salt_average()', 'id': 'average_salt', 'class': 'input', 'type': 'number', 'style': 'width: 50px; text-align: center;'}),
        }
...
class FormCReadForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'storage_1': forms.TextInput(attrs={'id': 'storage_1', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_2': forms.TextInput(attrs={'id': 'storage_2', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_3': forms.TextInput(attrs={'id': 'storage_3', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_4': forms.TextInput(attrs={'id': 'storage_4', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_5': forms.TextInput(attrs={'id': 'storage_5', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_6': forms.TextInput(attrs={'id': 'storage_6', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_7': forms.TextInput(attrs={'id': 'storage_7', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_8': forms.TextInput(attrs={'id': 'storage_8', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_9': forms.TextInput(attrs={'id': 'storage_9', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_10': forms.TextInput(attrs={'id': 'storage_10', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_11': forms.TextInput(attrs={'id': 'storage_11', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'storage_12': forms.TextInput(attrs={'id': 'storage_12', 'oninput': 'storage_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_1': forms.TextInput(attrs={'id': 'salt_1', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_2': forms.TextInput(attrs={'id': 'salt_2', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_3': forms.TextInput(attrs={'id': 'salt_3', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_4': forms.TextInput(attrs={'id': 'salt_4', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_5': forms.TextInput(attrs={'id': 'salt_5', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_6': forms.TextInput(attrs={'id': 'salt_6', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_7': forms.TextInput(attrs={'id': 'salt_7', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_8': forms.TextInput(attrs={'id': 'salt_8', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_9': forms.TextInput(attrs={'id': 'salt_9', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_10': forms.TextInput(attrs={'id': 'salt_10', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_11': forms.TextInput(attrs={'id': 'salt_11', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
            'salt_12': forms.TextInput(attrs={'id': 'salt_12', 'oninput': 'salt_average()', 'class': 'input', 'type': 'text', 'style': 'width: 50px; text-align: center;'}),
        }
...
class formA3_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'crew': forms.Select(attrs={'style': 'width:40px;'}),
            'foreman': forms.Select(attrs={'style': 'width: 80px;'}),
            'om_start': forms.TimeInput(attrs={'oninput': 'offtake_time()', 'type': 'time', 'style': 'width: 120px;'}),
            'om_stop': forms.TimeInput(attrs={'oninput': 'offtake_time()', 'type': 'time', 'style': 'width: 120px;'}),
            'l_start': forms.TimeInput(attrs={'oninput': 'lid_time()', 'type': 'time', 'style': 'width: 120px;'}),
            'l_stop': forms.TimeInput(attrs={'oninput': 'lid_time()', 'type': 'time', 'style': 'width: 120px;'}),
...
class formB_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fugitive_dust_observed_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'supressant_applied_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'supressant_active_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'working_face_exceed_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'spills_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'pushed_back_0' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_0}),
            'coal_vessel_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_0}),
            'water_sprays_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_0}),
            'loader_lowered_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_0}),
            'working_water_sprays_0' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_0}),
            'barrier_thickness_0' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;', 'required': sec_1}),
            'surface_quality_0' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;', 'required': sec_1}),
            'surpressant_crust_0' : forms.Select(attrs={'oninput': 'info_already_entered()', 'style':'width: 50px;', 'required': sec_1}),
            ...
            'wharf_0' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            'breeze_0' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            ...
            'fugitive_dust_observed_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'supressant_applied_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'supressant_active_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'working_face_exceed_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'spills_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'pushed_back_1' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_1}),
            'coal_vessel_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_1}),
            'water_sprays_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_1}),
            'loader_lowered_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_1}),
            'working_water_sprays_1' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_1}),
            'barrier_thickness_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;', 'required': sec_1}),
            'surface_quality_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;', 'required': sec_1}),
            'surpressant_crust_1' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;', 'required': sec_1}),
            ...
            'wharf_1' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            'breeze_1' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            ...
            'fugitive_dust_observed_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'supressant_applied_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'supressant_active_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'working_face_exceed_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'spills_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'pushed_back_2' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_2}),
            'coal_vessel_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_2}),
            'water_sprays_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_2}),
            'loader_lowered_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_2}),
            'working_water_sprays_2' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_2}),
            'barrier_thickness_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;', 'required': sec_1}),
            'surface_quality_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;', 'required': sec_1}),
            'surpressant_crust_2' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;', 'required': sec_1}),
            ...
            'wharf_2' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            'breeze_2' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            ...
            'fugitive_dust_observed_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'supressant_applied_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'supressant_active_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'working_face_exceed_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'spills_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'pushed_back_3' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_3}),
            'coal_vessel_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_3}),
            'water_sprays_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_3}),
            'loader_lowered_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_3}),
            'working_water_sprays_3' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_3}),
            'barrier_thickness_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;', 'required': sec_1}),
            'surface_quality_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;', 'required': sec_1}),
            'surpressant_crust_3' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;', 'required': sec_1}),
            ...
            'wharf_3' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            'breeze_3' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            ...
            'fugitive_dust_observed_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'supressant_applied_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'supressant_active_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'working_face_exceed_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'spills_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'pushed_back_4' : forms.Select(attrs={'oninput':'hidden_material()', 'style':'width: 50px;', 'required': name_4}),
            'coal_vessel_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_4}),
            'water_sprays_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_4}),
            'loader_lowered_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_4}),
            'working_water_sprays_4' : forms.Select(attrs={'oninput':'hidden_vessel()', 'style':'width: 50px;', 'required': name_4}),
            'barrier_thickness_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 80px;', 'required': sec_1}),
            'surface_quality_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 60px;', 'required': sec_1}),
            'surpressant_crust_4' : forms.Select(attrs={'oninput':'info_already_entered()', 'style':'width: 50px;', 'required': sec_1}),
            ...
            'wharf_4' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
            'breeze_4' : forms.Select(attrs={'oninput':'house_keeping()', 'style':'width: 80px;', 'required': sec_2}),
        }

...
class form3_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'om_total_sec': forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style': 'width:80px; text-align: center;', 'required': True, 'min': "1"}),
            ...
            'l_total_sec': forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style': 'width:80px; text-align: center;', 'required': True, 'min': "1"}),
            'om_allowed_traverse_time': forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style': 'width:63px; text-align: center;', 'required': True, 'min': "0"}),
            'l_allowed_traverse_time': forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style': 'width:63px; text-align: center;', 'required': True, 'min': "0"}),
            ...
            'om_percent_leaking': forms.TextInput(attrs={'id': 'om_percent_leaking', 'type': 'number', 'step': '0.001', 'style': 'width: 80px; text-align: center;', 'min': "0"}),
            'l_percent_leaking': forms.TextInput(attrs={'id': 'l_percent_leaking', 'type': 'number', 'step': '0.001', 'style': 'width: 80px; text-align: center;', 'min': "0"}),
...
class form4_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'main_1': forms.NumberInput(attrs={'type': 'number', 'step': "0.001",  'style': 'width: 80px; text-align: center;'}),
            'main_2': forms.NumberInput(attrs={'type': 'number', 'step': "0.001",  'style': 'width: 80px; text-align: center;'}),
            'main_3': forms.NumberInput(attrs={'type': 'number', 'step': "0.001",  'style': 'width: 80px; text-align: center;'}),
            'main_4': forms.NumberInput(attrs={'type': 'number', 'step': "0.001",  'style': 'width: 80px; text-align: center;'}),
            'suction_main': forms.NumberInput(attrs={'type': 'number', 'step': "0.001",  'style': 'width: 100px; text-align: center;'}),
...
class form5_form(ModelForm):
    class Meta:
        ...
        widgets = {
            'date': forms.DateInput(attrs={'type': 'date'}),
            'cert_date': forms.DateInput(attrs={'type': 'date'}),
    ...
    JSON_WIDGET_STYLES = {
        "process_equip1": forms.TextInput(attrs={"class": "input", "type": "text"}),
        "process_equip2": forms.TextInput(attrs={"class": "input", "type": "text"}),
        "background_color_start": forms.TextInput(attrs={"class": "input", "type": "text", "style": "width: 80px; text-align: center;"}),
        "background_color_stop": forms.TextInput(attrs={"class": "input", "type": "text", "style": "width: 80px; text-align: center;"}),
        "sky_conditions": forms.TextInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "text", "style": "width: 150px; text-align: center;"}),
        "wind_speed_start": forms.NumberInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "number", "style": "width: 80px; text-align: center;"}),
        "wind_speed_stop": forms.TextInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "text", "style": "width: 80px; text-align: center;"}),
        ...
        "ambient_temp_start": forms.NumberInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "number", "style": "width: 80px; text-align: center;"}),
        "ambient_temp_stop": forms.TextInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "text", "style": "width: 80px; text-align: center;"}),
        "humidity": forms.NumberInput(attrs={"oninput": "weatherStoplight()", "class": "input", "type": "number", "style": "width: 80px; text-align: center;"}),
        "height_above_ground": forms.NumberInput(attrs={"class": "input", "type": "number", "style": "text-align: center; width: 20%;"}),
        "height_rel_observer": forms.NumberInput(attrs={"class": "input", "type": "number", "style": "text-align: center; width: 20%;"}),
        "distance_from": forms.NumberInput(attrs={"class": "input", "type": "number", "style": "text-align: center; width: 20%;"}),
        "direction_from": forms.TextInput(attrs={"oninput": "this.value = this.value.toUpperCase()", "class": "input", "type": "text", "style": "text-align: center; width: 20%;"}),
        ...
        "op_mode1": forms.TextInput(attrs={"name": "op_mode1", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        "op_mode2": forms.TextInput(attrs={"name": "op_mode2", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        ...
        "describe_emissions_start": forms.TextInput(attrs={"name": "describe_emissions_start", "maxlength": "50", "required": True, "class": "input", "type": "text"}),
        "describe_emissions_stop": forms.TextInput(attrs={"name": "describe_emissions_stop", "maxlength": "50", "required": True, "class": "input", "type": "text"}),
        "emission_color_start": forms.TextInput(attrs={"name": "emission_color_start", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        "emission_color_stop": forms.TextInput(attrs={"name": "emission_color_stop", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        "water_drolet_present": forms.Select(
            choices=[("", "---------"), ("Yes", "Yes"), ("No", "No")],
            attrs={"name": "water_drolet_present", "required": True, "class": "input"}
        ),
        "water_droplet_plume": forms.Select(
            choices=[("", "---------"), ("N/A", "N/A"), ("Attached", "Attached"), ("Detached", "Detached")],
            attrs={"name": "water_droplet_plume", "required": True, "class": "input"}
        ),
        "plume_opacity_determined_start": forms.TextInput(attrs={"name": "plume_opacity_determined_start", "maxlength": "50", "required": True, "class": "input", "type": "text"}),
        "plume_opacity_determined_stop": forms.TextInput(attrs={"class": "input", "type": "text"}),
        "describe_background_start": forms.TextInput(attrs={"name": "describe_background_start", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        "describe_background_stop": forms.TextInput(attrs={"name": "describe_background_stop", "maxlength": "30", "required": True, "class": "input", "type": "text"}),
        ...
        'o1_highest_opacity' : forms.NumberInput(attrs={'oninput': 'averages_pt1()', 'id': 'o1_highest_opacity','class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o2_highest_opacity' : forms.NumberInput(attrs={'oninput': 'averages_pt2()', 'id': 'o2_highest_opacity','class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o3_highest_opacity' : forms.NumberInput(attrs={'oninput': 'averages_pt3()', 'id': 'o3_highest_opacity','class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o4_highest_opacity' : forms.NumberInput(attrs={'oninput': 'averages_pt4()', 'id': 'o4_highest_opacity','class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o1_average_6' : forms.NumberInput(attrs={"step": "0.01", 'oninput': 'averages_pt1()', 'id': 'o1_average_6', 'class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o2_average_6' : forms.NumberInput(attrs={"step": "0.01", 'oninput': 'averages_pt2()', 'id': 'o2_average_6', 'class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o3_average_6' : forms.NumberInput(attrs={"step": "0.01", 'oninput': 'averages_pt3()', 'id': 'o3_average_6', 'class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o4_average_6' : forms.NumberInput(attrs={"step": "0.01", 'oninput': 'averages_pt4()', 'id': 'o4_average_6', 'class': 'input', 'type': 'number', 'style':'width: 80px; text-align: center;'}),
        'o1' : forms.NumberInput(attrs={'id' : 'o1', 'class': 'input', 'type': 'number', 'style':'width: 70px; text-align: center;'}),
        'o2' : forms.NumberInput(attrs={'id' : 'o2', 'class': 'input', 'type': 'number', 'style':'width: 70px; text-align: center;'}),
        'o3' : forms.NumberInput(attrs={'id' : 'o3', 'class': 'input', 'type': 'number', 'style':'width: 70px; text-align: center;'}),
        'o4' : forms.NumberInput(attrs={'id' : 'o4', 'class': 'input', 'type': 'number', 'style':'width: 70px; text-align: center;'}),

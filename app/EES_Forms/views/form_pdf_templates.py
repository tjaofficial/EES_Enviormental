...
def pdf_template_A5(primaryData, secondaryData, formInformation):
    ...
    tableData = [
        ...
        ['', '', '', '0', secondaryData.o1_1_reads, secondaryData.o1_2_reads, secondaryData.o1_3_reads, secondaryData.o1_4_reads, '', '', '', '0', secondaryData.o2_1_reads, secondaryData.o2_2_reads, secondaryData.o2_3_reads, secondaryData.o2_4_reads, ''],
        ['', '', '', '1', secondaryData.o1_5_reads, secondaryData.o1_6_reads, secondaryData.o1_7_reads, secondaryData.o1_8_reads, '', '', '', '1', secondaryData.o2_5_reads, secondaryData.o2_6_reads, secondaryData.o2_7_reads, secondaryData.o2_8_reads, ''],
        ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ...
        ['', '', '', '0', secondaryData.o1_9_reads, secondaryData.o1_10_reads, secondaryData.o1_11_reads, secondaryData.o1_12_reads, '', '', '', '0', secondaryData.o2_9_reads, secondaryData.o2_10_reads, secondaryData.o2_11_reads, secondaryData.o2_12_reads, ''],
        ['', '', '', '1', secondaryData.o1_13_reads, secondaryData.o1_14_reads, secondaryData.o1_15_reads, secondaryData.o1_16_reads, '', '', '', '1', secondaryData.o2_13_reads, secondaryData.o2_14_reads, secondaryData.o2_15_reads, secondaryData.o2_16_reads, ''],
        ['', '', Paragraph('<para fontSize=9>Highest Instantaneous Opacity:&#160;' + str(secondaryData.o1_highest_opacity) + '%</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Highest Instantaneous Opacity:&#160;' + str(secondaryData.o2_highest_opacity) + '%</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Instantaneous Over 20%?&#160;' + str(secondaryData.o1_instant_over_20) + '</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Instantaneous Over 20%?&#160;' + str(secondaryData.o2_instant_over_20) + '</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings:&#160;' + str(secondaryData.o1_average_6) + '%</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings:&#160;' + str(secondaryData.o2_average_6) + '%</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings Over 35%?&#160;' + str(secondaryData.o1_average_6_over_35) + '</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings Over 35%?&#160;' + str(secondaryData.o2_average_6_over_35) + '</para>', styles['Normal']), '', '', '', '', '', ''],
        # bottom data starts at (0,30)
        ['', '', o3NumberTime, '', '', '', '', '', '', '', o4NumberTime, '', '', '', '', '', ''],
        ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=10 leading=9><b>P</b></para>',styles['Normal']), '', '0', '15', '30', '45', '', '', Paragraph('<para fontSize=10 leading=9><b>P</b></para>',styles['Normal']), '', '0', '15', '30', '45', ''],
        ['', '', '', '0', secondaryData.o3_1_reads, secondaryData.o3_2_reads, secondaryData.o3_3_reads, secondaryData.o3_4_reads, '', '', '', '0', secondaryData.o4_1_reads, secondaryData.o4_2_reads, secondaryData.o4_3_reads, secondaryData.o4_4_reads, ''],
        ['', '', '', '1', secondaryData.o3_5_reads, secondaryData.o3_6_reads, secondaryData.o3_7_reads, secondaryData.o3_8_reads, '', '', '', '1', secondaryData.o4_5_reads, secondaryData.o4_6_reads, secondaryData.o4_7_reads, secondaryData.o4_8_reads, ''],
        ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=10 leading=9><b>T</b></para>',styles['Normal']), '', '0', '15', '30', '45', '', '', Paragraph('<para fontSize=10 leading=9><b>T</b></para>',styles['Normal']), '', '0', '15', '30', '45', ''],
        ['', '', '', '0', secondaryData.o3_9_reads, secondaryData.o3_10_reads, secondaryData.o3_11_reads, secondaryData.o3_12_reads, '', '', '', '0', secondaryData.o4_9_reads, secondaryData.o4_10_reads, secondaryData.o4_11_reads, secondaryData.o4_12_reads, ''],
        ['', '', '', '1', secondaryData.o3_13_reads, secondaryData.o3_14_reads, secondaryData.o3_15_reads, secondaryData.o3_16_reads, '', '', '', '1', secondaryData.o4_13_reads, secondaryData.o4_14_reads, secondaryData.o4_15_reads, secondaryData.o4_16_reads, ''],
        ['', '', Paragraph('<para fontSize=9>Highest Instantaneous Opacity:&#160;' + str(secondaryData.o3_highest_opacity) + '%</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Highest Instantaneous Opacity:&#160;' + str(secondaryData.o4_highest_opacity) + '%</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Instantaneous Over 20%?&#160;' + str(secondaryData.o3_instant_over_20) + '</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Instantaneous Over 20%?&#160;' + str(secondaryData.o4_instant_over_20) + '</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings:&#160;' + str(secondaryData.o3_average_6) + '%</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings:&#160;' + str(secondaryData.o4_average_6) + '%</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings Over 35%?&#160;' + str(secondaryData.o3_average_6_over_35) + '</para>', styles['Normal']), '', '', '', '', '', '', '', Paragraph('<para fontSize=9>Average Opacity of 6 Highest Readings Over 35%?&#160;' + str(secondaryData.o4_average_6_over_35) + '</para>', styles['Normal']), '', '', '', '', '', ''],
        ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],

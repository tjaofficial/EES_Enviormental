...
from ..models import form_settings_model, form21_model
from ..forms import form21_form
...
@lock
def form21(request, fsID, selector):
    # -----SET MAIN VARIABLES------------
    ...
    # -----SET FORM VARIABLE IN RESPONSE TO DECIDING VARIABLES------------
        if existing:
            form = form21_form(request.POST, instance=database_form, form_settings=form_settings)
        else:
            form = form21_form(request.POST, form_settings=form_settings)

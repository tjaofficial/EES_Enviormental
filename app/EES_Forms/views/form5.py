...
@lock
def form5(request, fsID, selector):
    variables = {}
    # -----SET MAIN VARIABLES------------
    ...
    if search:
        ...
        if existing:
            ...
            initial_data = {
                ...
                'cert_date': cert_date,
                'process_equip1': form_variables['freq'].settings['settings']['process_equip1'],
                'process_equip2': form_variables['freq'].settings['settings']['process_equip2'],
                'op_mode1': form_variables['freq'].settings['settings']['operating_mode1'],
                'op_mode2': form_variables['freq'].settings['settings']['operating_mode2'],
                'emission_point_start': form_variables['freq'].settings['settings']['describe_emissions_point_start'],
                'emission_point_stop': form_variables['freq'].settings['settings']['describe_emissions_point_stop'],
                ...
                'water_drolet_present': form_variables['freq'].settings['settings']['water_drolet_present'],
                'water_droplet_plume': form_variables['freq'].settings['settings']['water_droplet_plume'],
                'plume_opacity_determined_start': form_variables['freq'].settings['settings']['plume_opacity_determined_start'],
                'plume_opacity_determined_stop': form_variables['freq'].settings['settings']['plume_opacity_determined_stop'],
                'describe_background_start': form_variables['freq'].settings['settings']['describe_background_start'],
                'describe_background_stop': form_variables['freq'].settings['settings']['describe_background_stop'],
                'wind_speed_stop': 'TBD',

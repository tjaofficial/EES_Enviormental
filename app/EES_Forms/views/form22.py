...
from ..utils.main_utils import fix_data, get_initial_data,updateSubmissionForm, createNotification
...
@lock
def form22(request, fsID, selector):
    fix_data(fsID)
    # -----SET MAIN VARIABLES------------
    ...
    return render(request, "shared/forms/daily/form22.html", {
        'fsID': fsID, 

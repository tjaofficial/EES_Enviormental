function getid(obj) {
    ...
    document.getElementById("replaceContent").innerHTML = "<div class='contact_data_cont'><div class='contact_image'></div><div class='contact_data_cont_inner'><p>"+name+"</p><div class='contact_data'><p>Phone: "+phone+"</p><p>Email: "+email+"</p><p>Certification Date: "+cert_date+"</p></div></div></div><a href='../../ees_forms/admin/Register/"+email+"'><div id='edit'>Edit</div></a>";
}

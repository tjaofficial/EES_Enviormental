...
class formA2_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'c_start' : forms.TimeInput(attrs={'oninput': 'timecheck_cokeDoors()', 'id':'c_start', 'id':'c_start', 'type':'time', 'style':'width: 120px;'}),
            'c_stop' : forms.TimeInput(attrs={'oninput': 'timecheck_cokeDoors()', 'id':'c_start', 'id':'c_stop', 'type':'time', 'style':'width: 120px;'}),
            'p_temp_block_from' : forms.TextInput(attrs={'oninput': 'equation()', 'id':'p_temp_block_from', 'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            'p_temp_block_to' : forms.TextInput(attrs={'oninput': 'equation()', 'id':'p_temp_block_to', 'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;', 'oninput':'pc_doors_not_observed()'}),
            'c_temp_block_from' : forms.TextInput(attrs={'oninput': 'equation()', 'id':'c_temp_block_from', 'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            ...
            'doors_not_observed' : forms.NumberInput(attrs={'onchange':'equation()', 'id':'doors_not_observed', 'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'inop_doors_eq' : forms.NumberInput(attrs={'onchange':'equation()', 'id':'inop_doors_eq', 'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),

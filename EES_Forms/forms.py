...
class formA2_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'p_temp_block_from' : forms.TextInput(attrs={'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            'p_temp_block_to' : forms.TextInput(attrs={'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            'c_temp_block_from' : forms.TextInput(attrs={'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            'c_temp_block_to' : forms.TextInput(attrs={'class': 'input', 'type': 'text', 'style':'width:50px; text-align: center;'}),
            'p_traverse_time_min' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'p_traverse_time_sec' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'c_traverse_time_min' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'c_traverse_time_sec' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'total_traverse_time' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'allowed_traverse_time' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'valid_run' : forms.CheckboxInput(attrs={'style':'width: 50px;'}),
            'leaking_doors' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            ...
            'c_leak_oven1' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
...
class formA3_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'om_oven1' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'om_loc1' : forms.Select(attrs={'style':'width:40px;'}),
            'l_oven1' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            ...
            'om_leaks' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'l_leaks' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'om_not_observed' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'l_not_observed' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width:50px; text-align: center;'}),
            'om_percent_leaking' : forms.TextInput(attrs={'type':'text', 'style':'width: 50px; text-align: center;'}),
            'l_percent_leaking' : forms.TextInput(attrs={'type':'text', 'style':'width: 50px; text-align: center;'}),
...
class formA5_readings_form(ModelForm):
    class Meta:
        ...
        widgets = {
            'o1_highest_opacity' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o1_average_6' : forms.NumberInput(attrs={'id': 'o1_average_6', 'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o2_highest_opacity' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o2_average_6' : forms.NumberInput(attrs={'id': 'o2_average_6', 'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o3_highest_opacity' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o3_average_6' : forms.NumberInput(attrs={'id': 'o3_average_6', 'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o4_highest_opacity' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o4_average_6' : forms.NumberInput(attrs={'id': 'o4_average_6', 'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o1' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o2' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o3' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o4' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            'o5' : forms.NumberInput(attrs={'class': 'input', 'type': 'number', 'style':'width: 40px; text-align: center;'}),
            ...
            'o1_1_reads' : forms.TextInput(attrs={'id':'o1_1_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_2_reads' : forms.TextInput(attrs={'id':'o1_2_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_3_reads' : forms.TextInput(attrs={'id':'o1_3_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_4_reads' : forms.TextInput(attrs={'id':'o1_4_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_5_reads' : forms.TextInput(attrs={'id':'o1_5_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_6_reads' : forms.TextInput(attrs={'id':'o1_6_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_7_reads' : forms.TextInput(attrs={'id':'o1_7_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_8_reads' : forms.TextInput(attrs={'id':'o1_8_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_9_reads' : forms.TextInput(attrs={'id':'o1_9_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_10_reads' : forms.TextInput(attrs={'id':'o1_10_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_11_reads' : forms.TextInput(attrs={'id':'o1_11_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_12_reads' : forms.TextInput(attrs={'id':'o1_12_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_13_reads' : forms.TextInput(attrs={'id':'o1_13_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_14_reads' : forms.TextInput(attrs={'id':'o1_14_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_15_reads' : forms.TextInput(attrs={'id':'o1_15_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o1_16_reads' : forms.TextInput(attrs={'id':'o1_16_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            
            'o2_1_reads' : forms.TextInput(attrs={'id':'o2_1_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_2_reads' : forms.TextInput(attrs={'id':'o2_2_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_3_reads' : forms.TextInput(attrs={'id':'o2_3_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_4_reads' : forms.TextInput(attrs={'id':'o2_4_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_5_reads' : forms.TextInput(attrs={'id':'o2_5_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_6_reads' : forms.TextInput(attrs={'id':'o2_6_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_7_reads' : forms.TextInput(attrs={'id':'o2_7_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_8_reads' : forms.TextInput(attrs={'id':'o2_8_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_9_reads' : forms.TextInput(attrs={'id':'o2_9_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_10_reads' : forms.TextInput(attrs={'id':'o2_10_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_11_reads' : forms.TextInput(attrs={'id':'o2_11_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_12_reads' : forms.TextInput(attrs={'id':'o2_12_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_13_reads' : forms.TextInput(attrs={'id':'o2_13_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_14_reads' : forms.TextInput(attrs={'id':'o2_14_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_15_reads' : forms.TextInput(attrs={'id':'o2_15_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o2_16_reads' : forms.TextInput(attrs={'id':'o2_16_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            
            'o3_1_reads' : forms.TextInput(attrs={'id':'o3_1_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_2_reads' : forms.TextInput(attrs={'id':'o3_2_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_3_reads' : forms.TextInput(attrs={'id':'o3_3_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_4_reads' : forms.TextInput(attrs={'id':'o3_4_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_5_reads' : forms.TextInput(attrs={'id':'o3_5_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_6_reads' : forms.TextInput(attrs={'id':'o3_6_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_7_reads' : forms.TextInput(attrs={'id':'o3_7_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_8_reads' : forms.TextInput(attrs={'id':'o3_8_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_9_reads' : forms.TextInput(attrs={'id':'o3_9_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_10_reads' : forms.TextInput(attrs={'id':'o3_10_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_11_reads' : forms.TextInput(attrs={'id':'o3_11_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_12_reads' : forms.TextInput(attrs={'id':'o3_12_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_13_reads' : forms.TextInput(attrs={'id':'o3_13_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_14_reads' : forms.TextInput(attrs={'id':'o3_14_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_15_reads' : forms.TextInput(attrs={'id':'o3_15_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o3_16_reads' : forms.TextInput(attrs={'id':'o3_16_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            
            'o4_1_reads' : forms.TextInput(attrs={'id':'o4_1_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_2_reads' : forms.TextInput(attrs={'id':'o4_2_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_3_reads' : forms.TextInput(attrs={'id':'o4_3_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_4_reads' : forms.TextInput(attrs={'id':'o4_4_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_5_reads' : forms.TextInput(attrs={'id':'o4_5_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_6_reads' : forms.TextInput(attrs={'id':'o4_6_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_7_reads' : forms.TextInput(attrs={'id':'o4_7_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_8_reads' : forms.TextInput(attrs={'id':'o4_8_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_9_reads' : forms.TextInput(attrs={'id':'o4_9_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_10_reads' : forms.TextInput(attrs={'id':'o4_10_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_11_reads' : forms.TextInput(attrs={'id':'o4_11_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_12_reads' : forms.TextInput(attrs={'id':'o4_12_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_13_reads' : forms.TextInput(attrs={'id':'o4_13_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_14_reads' : forms.TextInput(attrs={'id':'o4_14_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_15_reads' : forms.TextInput(attrs={'id':'o4_15_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
            'o4_16_reads' : forms.TextInput(attrs={'id':'o4_16_reads', 'class': 'input', 'oninput':'pt_averages()', 'type': 'text', 'style':'width: 50px; text-align: center;'}),
        }
...
class formB_form(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fugitive_dust_observed_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_applied_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_active_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_face_exceed_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'spills_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'pushed_back_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'coal_vessel_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'water_sprays_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'loader_lowered_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_water_sprays_1' : forms.Select(attrs={'style':'width: 50px;'}),
            'barrier_thickness_1' : forms.Select(attrs={'style':'width: 80px;'}),
            'surface_quality_1' : forms.Select(attrs={'style':'width: 60px;'}),
            'surpressant_crust_1' : forms.Select(attrs={'style':'width: 50px;'}),
            ...
            'fugitive_dust_observed_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_applied_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_active_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_face_exceed_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'spills_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'pushed_back_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'coal_vessel_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'water_sprays_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'loader_lowered_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_water_sprays_2' : forms.Select(attrs={'style':'width: 50px;'}),
            'barrier_thickness_2' : forms.Select(attrs={'style':'width: 80px;'}),
            'surface_quality_2' : forms.Select(attrs={'style':'width: 60px;'}),
            'surpressant_crust_2' : forms.Select(attrs={'style':'width: 50px;'}),
            ...
            'fugitive_dust_observed_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_applied_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_active_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_face_exceed_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'spills_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'pushed_back_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'coal_vessel_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'water_sprays_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'loader_lowered_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_water_sprays_3' : forms.Select(attrs={'style':'width: 50px;'}),
            'barrier_thickness_3' : forms.Select(attrs={'style':'width: 80px;'}),
            'surface_quality_3' : forms.Select(attrs={'style':'width: 60px;'}),
            'surpressant_crust_3' : forms.Select(attrs={'style':'width: 50px;'}),
            ...
            'fugitive_dust_observed_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_applied_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'supressant_active_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_face_exceed_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'spills_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'pushed_back_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'coal_vessel_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'water_sprays_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'loader_lowered_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'working_water_sprays_4' : forms.Select(attrs={'style':'width: 50px;'}),
            'barrier_thickness_4' : forms.Select(attrs={'style':'width: 80px;'}),
            'surface_quality_4' : forms.Select(attrs={'style':'width: 60px;'}),
            'surpressant_crust_4' : forms.Select(attrs={'style':'width: 50px;'}),
            ...
            'wharf_4' : forms.Select(attrs={'style':'width: 80px;'}),
            'breeze_4' : forms.Select(attrs={'style':'width: 80px;'}),
        }

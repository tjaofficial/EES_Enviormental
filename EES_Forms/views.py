...
def pt_mth_input(request):
    ...
    return render(request, "ees_forms/pt_mth_input.html", {
        ...
        "back": back,
        "today": today,
        'submitted_ordered': submitted_ordered,
        'sort': sort,
        'profile': profile,
    })
            ...
            if now.month == todays_log.date_save.month:
                if now.day == todays_log.date_save.day:
                    ...
                    if count1 and count2 != 0:
                        ...
                        database_form = todays_log.date_save.date
...
def formG1(request, selector):
    ...
    return render(request, "Weekly/formG1.html", {
        "back": back, 'data': data, 'profile_form': profile_form,  'selector': selector, 'profile': profile, 'todays_log': todays_log
    })
...
def formH(request, access_page):
    ...
    return render(request, "Weekly/formH.html", {
        "back": back, 'data': data, 'profile_form': profile_form, 'access_page': access_page, 'profile': profile, 'todays_log': todays_log
    })

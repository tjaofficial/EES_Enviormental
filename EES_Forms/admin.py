...
class EventAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['previous_month'] = reverse('admin:EES_Forms_event_changelist') + '?day__gte=' + str(previous_month)

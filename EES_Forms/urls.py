...
urlpatterns = [
    ...
    path("Daily/Method303/formA1/<str:selector>", views.formA1, name="formA1"),
    path("Daily/Method303/formA2/<str:selector>", views.formA2, name="formA2"),
    path("Daily/Method303/formA3/<str:selector>", views.formA3, name="formA3"),
    path("Daily/Method303/formA4/<str:selector>", views.formA4, name="formA4"),
    path("Daily/Method303/formA5/<str:selector>", views.formA5, name="formA5"),
